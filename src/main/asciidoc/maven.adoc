...
TIP: Er is door mij deze week redelijk vaak alleen 
[source, xml]
----
$ mvn (enter)
----
ingetikt tijdens de les. Dit kan ALLEEN als er in je pom.xml onder de builds/build een defaultGoal vermeld staat.
